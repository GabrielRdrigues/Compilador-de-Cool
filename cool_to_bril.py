...
class CoolToBrilCompiler:
    ...
    def compile_program(self, program: Any) -> JsonDict:
        ...
        # -----------------------------------------------------------------
        # INJEÇÃO DE RUNTIME: Ajustando assinaturas para receberem self_ptr
        # -----------------------------------------------------------------
        # Stub para literais de String
        self.functions.append({
            "name": "__cool_string_literal",
            "args": [],
            "type": "int",
            "instrs": [
        ...
        # CORREÇÃO: Stub para o método concat da classe String
        self.functions.append({
            "name": "String.concat",
            "args": [{"name": "self_ptr", "type": "int"}, {"name": "other_ptr", "type": "int"}],
            "type": "int",
            "instrs": [
                {"op": "const", "dest": "res", "type": "int", "value": 0}, # Retorna um identificador de string simbólico
                {"op": "ret", "args": ["res"]}
            ]
        })

        # Stubs para os métodos da classe IO
        self.functions.append({
            "name": "IO.out_string",
            "args": [{"name": "self_ptr", "type": "int"}, {"name": "str_ptr", "type": "int"}],
            "type": "int",
            "instrs": [
                {"op": "print", "args": ["str_ptr"]}, 
        ...
        self.functions.append({
            "name": "IO.in_string",
            "args": [{"name": "self_ptr", "type": "int"}],
            "type": "int",
            "instrs": [
                {"op": "const", "dest": "res", "type": "int", "value": 42},
                {"op": "ret", "args": ["res"]}
            ]
        })
    ...
    def compile_expr(self, expr: Any) -> str:
        ...
        if kind == "StringLiteral":
            return self._emit_runtime_placeholder("int", "__cool_string_literal", [])
    ...
    def _emit_const(self, dest: str, type_name: BrilType, value: int | bool) -> None:
